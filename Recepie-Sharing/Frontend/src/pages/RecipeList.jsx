        ...
        {recipes.map((recipe) => (
          <div key={recipe._id} style={simpleCard}>
            ...
            <div style={imageContainer}>
              <img
                src={recipe.image || "https://via.placeholder.com/300x300?text=Food"}
                alt={recipe.title}
                style={imgStyle}
              />
            </div>
            ...
            <div style={infoContainer}>
              <div style={topRow}>
                ...
                <div style={actionButtons}>
                  <button onClick={() => navigate(`/edit-recipe/${recipe._id}`)} style={textBtn}>Edit</button>
                  <button onClick={() => handleDelete(recipe._id)} style={deleteTextBtn}>Delete</button>
                </div>
              </div>
...
const header = { marginBottom: "40px", borderBottom: "1px solid #ddd", paddingBottom: "20px" };
...
const infoContainer = { padding: "25px", flex: 1, display: "flex", flexDirection: "column" };
...
const authorLine = { fontSize: "0.85rem", color: "#999", margin: "5px 0 15px 0" };

const descText = { fontSize: "0.95rem", color: "#555", lineHeight: "1.5", margin: "0 0 15px 0" };

const detailsArea = { fontSize: "0.9rem", color: "#444", backgroundColor: "#fcfcfc", padding: "10px", borderRadius: "6px" };
...
const linkBtn = { textDecoration: "none", color: "#6b8e6b", fontWeight: "bold", fontSize: "0.9rem" };

const actionButtons = { display: "flex", gap: "10px" };

const textBtn = { 
  background: "none", border: "none", cursor: "pointer", color: "#007bff", fontSize: "0.8rem", padding: 0 
};

const deleteTextBtn = { 
  ...textBtn, color: "#dc3545" 
};
